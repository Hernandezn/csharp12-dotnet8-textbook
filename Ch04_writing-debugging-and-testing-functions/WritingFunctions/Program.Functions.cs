...
partial class Program
{
    ...
    {
        WriteLine($"This is the {number} times table with {size} entries\n");
    ...
    static decimal CalculateTax(decimal amount, string twoLetterRegionCode)
    {
        ...
        {
            "CH" => 0.08M, // swiss
            "DK" or "NO" => 0.25M, // danish, norwegian
            "GB" or "FR" => 0.2M, // british, french
            "HU" => 0.27M, // hungarian
            "OR" or "AK" or "MT" => 0.0M, // oregonian, alaskan, or montanan
            "ND" or "WI" or "ME" or "VA" => 0.05M,
            "CA" => 0.0825M, // californian
            _ => 0.06M // others
        };
    ...
    // enables UTF-8 encoding for console output
    ...
    /// <summary>
    /// Pass a 32-bit unsigned integer, and it will be converted to an ordinal number.
    /// </summary>
    ...
    static void RunFactorial()
    {
        for (int i = -2; i <= 15; i++)
        {
            ...
            {
                WriteLine($"{i}! throws {exc.GetType()}: {exc.Message}");
            }
        }
    }
